...
import { radioIcon, radioActiveIcon } from "./@icons";
import { shadowStyles, fontStyles } from "./@styles";

class ZRadio extends LitElement {
  ...
  render() {
    ...
    return html`
      <i class="checkbox">
        ${checked ? radioActiveIcon : radioIcon}
      </i>
...
window.customElements.define("z-radio", ZRadio);
